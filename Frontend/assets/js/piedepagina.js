...
function getMenu(_id) {
    ...
    <footer class="bg-black text-center text-lg-start mt-4">
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            <div class="container">
                <h2 class="mb-2 text-primary">Información del Casino</h2>
                <p class="h5 text-info text-justify">Bienvenido a nuestro casino en línea, donde la emoción y la diversión nunca terminan. Ofrecemos
                ...
                <p class="h5 text-info text-justify">Nuestro compromiso es brindarte un entorno seguro y justo para que puedas jugar con confianza.
